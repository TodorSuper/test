...
/*	'DB_HOST' => '192.168.11.108,192.168.11.108', // 服务器地址
	...
	"DB_MASTER" => array(
		...
		'DB_NAME' => 'lrw_db_beta', // 数据库名
		'DB_USER' => 'lrw_beta', // 用户名
		'DB_PWD' => 'rXqcFduPUIujairIqtTa', // 密码
		'DB_PORT' => '3306', // 端口
	),
    ...
    'REDIS_CONNECT_CONFIG' => array(//redis 链接池配置
        'master' => array('host' => 'd2c298a8815d4714.m.cnbja.kvstore.aliyuncs.com', 'port' => 6379, 'pwd'=>"d2c298a8815d4714:XTWf3JHfWM"), //主服务器配置
        'slave' => array(//从服务器配置
    ...
    'QUEUE_WORKER_HOST' => array(//队列异步调用地址 SERVER_API 地址 开发环境可以填写本机内网地址
        'host' => 'http://beta.api.liangrenwang.com/',
    ),
    'SPHINX_CONF' => array(
